...
# ROAD 
slope_road <- out_cov_dist_interaction30000$mean$beta.gamma[2]
lower_slope_road <- out_cov_dist_interaction30000$q2.5$beta.gamma[2]
upper_slope_road <- out_cov_dist_interaction30000$q97.5$beta.gamma[2]
...
# HARVEST DISTANCE 
#intercept <- out_cov$mean$beta.phi[1]
slope_harvest <- out_cov_dist_interaction30000$mean$beta.gamma[3]
lower_slope_harvest <- out_cov_dist_interaction30000$q2.5$beta.gamma[3]
upper_slope_harvest <- out_cov_dist_interaction30000$q97.5$beta.gamma[3]
